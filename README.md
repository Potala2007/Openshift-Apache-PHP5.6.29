...
2. Fill **Source Code** text field: `https://github.com/Potala2007/Openshift-Apache-PHP5.6.29.git`
...
* By default, PHP 5.6.29 is choosen, which can be found in `misc/make.sh`
